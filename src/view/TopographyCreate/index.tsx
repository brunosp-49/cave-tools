  ...
  const handleCreateTopography = async () => {
    try {
      const data = formData.map((topo: TopographyPoint) => ({
        ...
        azimuth: topo.azimuth.toString(),
        distance: topo.distance.toString(),
        from: topo.from.toString(),
        incline: topo.incline.toString(),
        to: topo.to.toString(),
        turnDown: topo.turnDown.toString(),
        turnLeft: topo.turnLeft.toString(),
        turnRight: topo.turnRight.toString(),
        turnUp: topo.turnUp.toString(),
      }))
